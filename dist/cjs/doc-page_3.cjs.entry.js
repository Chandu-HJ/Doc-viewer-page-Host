...
const DocWorkspace = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'f4dc64087c34375ff8d925d6fc21a25a79150e43', class: `workspace-container theme-${this.theme}` }, index.h("div", { key: 'd0d0d1f2decc5af7cfff2c1cb8acba3a714bd403', class: "workspace-toolbar" }, index.h("button", { key: 'f3703b4d9f3f0a617152f28c30cd52eb6aa741c9', class: "open-btn", onClick: () => this.fileInput?.click() }, "\uD83D\uDCC2 Open File"), index.h("input", { key: '3897c4dc09a3caa46c5e571b0176020fc300e345', type: "file", accept: ".pdf,.png,.jpg,.jpeg,.gif,.bmp,.webp,.txt,.md", style: { display: 'none' }, ref: (el) => (this.fileInput = el), onChange: this.onFileSelected }), index.h("div", { key: '85dd3f27d82ab406d5b31893189295c32a0f2749', class: "toolbar-spacer" }), index.h("label", { key: '278e72e8cc95bd712c2f36cef7ef5a6c2fe2cb19', class: "theme-label" }, "Theme:"), index.h("select", { key: 'bfe26abdef7e66b8a0c2c071daec35fe375940e3', class: "theme-select", onChange: (e) => {
                this.theme = e.target.value;
            } }, index.h("option", { key: 'bf75d41592c58fc9fe761f8cc333b28b1782b6dc', value: "light", selected: this.theme === 'light' }, "Light"), index.h("option", { key: '7f56e86ee5e43ab1fb7d1741c20b6adc4b7597c8', value: "dark", selected: this.theme === 'dark' }, "Dark"), index.h("option", { key: 'df9a34f961fad8b854049785ca6195dcadf955be', value: "sepia", selected: this.theme === 'sepia' }, "Sepia"))), index.h("div", { key: '9a45bd30f54eabf21983708c2804225971c2c885', class: "workspace-tabs" }, this.files.map((file) => (index.h("div", { class: {
                tab: true,
            ...
            } }, "\u2716"))))), index.h("div", { key: 'bdbc5bdb6b5fd15ebb3bbe4c2b24ca487bea81bb', class: "workspace-viewer" }, activeFile ? (index.h("doc-viewer", { key: activeFile.id, src: activeFile.url, fileType: activeFile.fileType, scale: 1.2, theme: this.theme, mode: "editor" // default for workspace
